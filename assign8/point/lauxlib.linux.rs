...
pub const DEB_HOST_MULTIARCH: &'static [u8; 17usize] = b"x86_64-linux-gnu\0";
pub const LUA_ROOT: &'static [u8; 12usize] = b"/usr/local/\0";
pub const LUA_ROOT2: &'static [u8; 6usize] = b"/usr/\0";
...
pub const LUA_VERSION_RELEASE: &'static [u8; 2usize] = b"3\0";
pub const LUA_VERSION: &'static [u8; 8usize] = b"Lua 5.3\0";
pub const LUA_RELEASE: &'static [u8; 10usize] = b"Lua 5.3.3\0";
pub const LUA_COPYRIGHT: &'static [u8; 52usize] =
    b"Lua 5.3.3  Copyright (C) 1994-2016 Lua.org, PUC-Rio\0";
